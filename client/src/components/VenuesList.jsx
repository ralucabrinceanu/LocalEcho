...
//   return (
//     <div className="mt-12 grid gap-y-8 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-x-6">
//       {venues.map((venue) => {
...
//           <div
//             key={venue.id}
//             className="p-6 rounded-lg flex flex-col shadow-lg hover:shadow-2xl transition-shadow duration-300 ease-in-out bg-transparent border border-red-500"
//           >
//             <div>
...
//               <Form method="post" action={`/venues/delete-venue/${venue.id}`}>
